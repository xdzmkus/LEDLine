...
GlowwormLedEffect<leds, NUM_LEDS>* effect;
...
void setup()
{
	...
	effect = new GlowwormLedEffect<leds, NUM_LEDS>(10);

	Serial.print(effect->name);	Serial.print(" "); Serial.println(effect->getNumWorms());
