...
#define BTN_PIN   16  // GPIO16 - touch button pin

#define LED_PIN_1 12  // GPIO12 - left strip
#define LED_PIN_2 13  // GPIO13 - center strip
#define LED_PIN_3 14  // GPIO14 - right strip

#define RELAY_PIN 15  // GPIO15 - relay pin
...
void publishState()
{
    ...
    wallLampState.publish(currentEffect);
}
